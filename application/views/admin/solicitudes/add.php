...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url();?>administrador/solicitudes"><i class="fa fa-dashboard"></i> Solicitudes</a></li>
            <li class="active">Solicitud Nuevo</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php endif;?>
                        <form action="<?php echo base_url();?>administrador/solicitudes/store" method="POST">
                                    ...
                                    <div class="form-group <?php echo !empty(form_error("ts_padre")) ? 'has-error':''?>">
                                        ...
                                        <option value="">Seleccionar....</option>
                                            <?php foreach ($tsoporte as $tp) :?>
                                                ...
                                                <?php echo set_select("ts_padre",$tp->id_tipo_soporte);?>>
                                ...
                                <div class="col-md-6">
                                     ...
                                     <label for="ts_nombre">Nombre del Soporte:</label>
                                        ...
                                        value="<?php echo set_value('ts_nombre');?>"
