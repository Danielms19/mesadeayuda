...
<head>
    ...
        <title>Mesa de Ayuda UGEL 04.</title>
       
...
<body style="margin: 0 !important; padding: 0 !important;">
    ...
    <div role="article" aria-label="An email from Your Brand Name" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <header>
            ...
            <a href="https://www.facebook.com/Ugel4">
                <center><img src="https://i.ibb.co/GWNRdwX/fondo.png" alt="" height="250" width="250"></center>
            </a>
            ...
            <article>
                ...
                <?php if( $estado == '1'):  ?>
                    <h2 style="color: #000000; font-size: 28px; font-weight: 600; line-height: 32px; margin: 48px 0 24px 0; text-align: center;">
                        <strong>
                            Confirmación de Asiginación de Técnico de Mesa de Ayuda
                        </strong>
                    </h2>
                    <p>
                        Estimado <strong><?php echo $nombres ?> </strong> del Área de <strong><?php echo $area ?> </strong> su solicitud de:<br>
                        Tipo de Soporte: <strong><?php echo $soporte ?> </strong> <br>
                        Descripcion: <strong><?php echo $descripcion ?> </strong> <br>
                        Fecha: <strong><?php echo $fecha_proceso ?> </strong> <br>
                        Tecnico Asignado: <strong> <?php echo $tec_nombres . ' ' . $tec_apellidos ?> </strong>
                ...
                <?php if( $estado == '5'):  ?>
                    <h2 style="color: #000000; font-size: 28px; font-weight: 600; line-height: 32px; margin: 48px 0 24px 0; text-align: center;">
                        <strong>
                            Confirmación de Cierre de solicitud
                        </strong>
                    </h2>
                    <p>
                        Estimado <strong><?php echo $nombres ?> </strong> del Área de <strong><?php echo $area ?> </strong> su solicitud de:<br>
                        ...
                        Descripcion: <strong><?php echo $descripcion ?> </strong> <br>
                        Fecha: <strong><?php echo $fecha_proceso ?> </strong> <br>
                        Se ha cerrado su solicitud por la observación: <strong><?php echo $observacion ?> </strong> <br>
                    </p>
                <?php endif ;?>
                ...
                <?php if( $estado == '2'):  ?>
                    ...
                    <p>
                        Estimado <strong><?php echo $nombres ?> </strong> del Área de <strong><?php echo $area ?> </strong> su solicitud de:<br>
                        Tipo de Soporte: <strong><?php echo $soporte ?> </strong> <br>
                        Diganostico : <strong><?php echo $diagnostico ?> </strong> <br>
                        Fecha: <strong><?php echo $fecha_proceso ?> </strong> <br>
                    </p>
                <?php endif ;?>
                ...
                <?php if( $estado == '4'):  ?>
                    ...
                    <p>
                        ...
                        Tipo de Soporte: <strong><?php echo $soporte ?> </strong> <br>
                        Fecha: <strong><?php echo $fecha_proceso ?> </strong> <br>
                        Resolutivo: <strong><?php echo $resolutivo ?> </strong> <br>
                    </p>
                <?php endif ;?>
        ...
        <footer>
            <div style="border-top: 2px solid #eaeaea; padding: 10px 0 0 0;">
                ...
                <p style="font-size: 16px; font-weight: 400; line-height: 24px; margin-top: 48px;">
                    © 2021 Todos los derechos reservados equipo de tecnologías de la información - UGEL 04
                    <a href="https://www.ugel04.gob.pe/" style="color: #B200FD; text-decoration: underline;">Puedes visitar nuestra página web.</a>
                </p>
            </div>
        </footer>
