<div class="container-fluid">
    ...
    <tbody>
        ...
        <input type="hidden" id="id_diagnostico" name="id_diagnostico" value="<?php echo $rpt->id_diagnostico;?>">
        <tr>
            ...
            <tr>
                ...
                <form>
                    <div class="form-group">        
                            <textarea class="form-control" rows="3" id="dg_descripcion" name="dg_descripcion" required
                            placeholder="Describa brevemente la Resolución de su solicitud de soporte técnico "><?php echo $rpt->dg_descripcion;?></textarea>      
                    </div>    
                </form>
