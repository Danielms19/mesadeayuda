<div class="container-fluid">
    ...
    <?php endforeach ?>
    <form>
        <h5><strong>Confirmar soporte y Resolutivo</strong></h5>
        <div class="form-group">
            <select  class="form-control" id="tipos_soporte_id_tipo_soporte" name="tipos_soporte_id_tipo_soporte" style="width: 100%">
            <?php foreach($rsoporte as $rs):?>
                <option value="<?php echo $rs->id_tipo_soporte;?>" 
                <?php echo $rs->id_tipo_soporte == $rpt->tipos_soporte_id_tipo_soporte ? "selected":"";?>>
                <?php echo $rs->ts_nombre;?></option>
            <?php endforeach;?>
            </select>
        </div>
        <div class="form-group">        
                <textarea class="form-control" rows="3" id="rs_descripcion" name="rs_descripcion" required
                placeholder="Describa brevemente la Resolución de su solicitud de soporte técnico"></textarea>      
        </div>    
    </form>
</div>
