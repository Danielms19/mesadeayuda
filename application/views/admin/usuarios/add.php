                        ...
                        <form action="<?php echo base_url();?>administrador/usuarios/store" method="POST">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label for="tc_nombres">Nombre:</label>
                                        ...
                                        value="<?php echo set_value('tc_nombres');?>"
                                ...
                                <div class="col-md-6">
                                     ...
                                     <label for="tc_apellidos">Apellidos:</label>
                                        ...
                                        value="<?php echo set_value('tc_apellidos');?>"
                                        onkeypress="return soloLetras(event)">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group <?php echo !empty(form_error("tc_dni")) ? 'has-error':''?>">
                                        ...
                                        value="<?php echo set_value('tc_dni');?>"
                                    ...
                                    <div class="form-group <?php echo !empty(form_error("tipo_soporte")) ? 'has-error':''?>">
                                        ...
                                        <option value="">Seleccionar Rol</option>
                                            <?php foreach ($tipo_soporte as $tp) :?>
                                                ...
                                                <?php echo set_select("tipo_soporte",$tp->id_tipo_usuario);?>>
